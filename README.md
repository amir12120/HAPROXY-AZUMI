...
```
apt install python3 -y && apt install pip -y &&  pip install colorama && pip install netifaces && apt install curl -y && python3 <(curl -Ls https://github.com/69learn/HAPROXY-AZUMI/refs/heads/main/haproxy.py --ipv4)
```
--------------------------------------
...
```
bash -c "$(curl -fsSL https://github.com/69learn/HAPROXY-AZUMI/refs/heads/main/managed.sh)"
```
